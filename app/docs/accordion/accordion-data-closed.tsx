...
export function AccordionDataClosed() {
  return (
    <Accordion
      ...
      <AccordionItem value='getting-started' className='py-2'>
        <AccordionTrigger className='w-full text-left text-zinc-950 dark:text-zinc-50'>
          <div className='flex items-center justify-between'>
            ...
            <ChevronDown className='h-4 w-4 text-zinc-950 transition-transform duration-200 group-data-[closed]:rotate-180  dark:text-zinc-50' />
          </div>
        </AccordionTrigger>
        <AccordionContent>
