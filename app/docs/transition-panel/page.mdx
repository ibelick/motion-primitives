...
import { TabsTransitionPanel } from '@/components/examples/transition-panel-tabs';
import { TransitionPanelCard } from '@/components/examples/transition-panel-card';
...
<ComponentCodePreview
  ...
  filePath='examples/transition-panel-tabs'
/>
...
<ComponentCodePreview
  ...
  filePath='examples/transition-panel-card'
/>
