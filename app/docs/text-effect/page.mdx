...
### Text Effect with duration

You can control the speed of the animation by using the `speedReveal` and `speedAnimation` props.
...
<CodeBlock
  code={`npx shadcn add "https://motion-primitives.com/c/text-effect.json"`}
  lang='bash'
  className='h-[52px]'
/>
...
| speedAnimation          | number                                                   | 1         | Controls the speed of the animation.                            |
